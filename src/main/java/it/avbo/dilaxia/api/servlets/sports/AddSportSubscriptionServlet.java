...
import it.avbo.dilaxia.api.database.UserSportSubscriptionSource;
...
public class AddSportSubscriptionServlet extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!request.isRequestedSessionIdValid()) {
            ...
            if (!UserSportSubscriptionSource.addUserSubscription(userSportSubscription)) {
                response.sendError(
                        HttpServletResponse.SC_INTERNAL_SERVER_ERROR,
